Submit to [https://goo.gl/forms/onNixqK9VkzkDSt03](https://goo.gl/forms/onNixqK9VkzkDSt03)
...
Some of the participants were unsure of how to apply some of the material to their daily work. While not all library staff may be expected to use the bash shell or regular expressions in their work, these lessons offer an opportunity to discuss problem solving and concepts like abstraction and atomization that apply to work outside the UNIX command line. Our future Library Carpentry workshops may afford more time for these ideas, combined with hands-on examples of working through increasingly complex tasks. One way this could be implemented would be to have "expert guests" attend a particular session. By chance, several of the sessions (the Tidy Data and SQL ones specifically) were attended by an expert that was curious about Library Carpentry. This person was able to provide additional tips, tricks, and information that wasn't part of the official curriculum but provided a real-world context to questions asked by participants.  Although a helper or possibly the instructor themselves could also fill this role, perhaps having an expert that isn't officially tasked with helping run the workshop makes them more able to offer additional tips that aren't in the curriculum but address individual questions that may come up. For example, in the SQL workshop, a student asked what the difference was between the SUM() and TOTAL() functions were. Neither the instructor nor the helper knew the answer off the top of their heads but the expert was able to address the question while the instructor and helper resumed the workshop.  
